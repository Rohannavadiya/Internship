...
<head>
    ...
    if (!empty($_GET['filter'])) {
        ...
        $sql = "SELECT * FROM income where income_date like '%$search%'or account_num like '%$search%'or amount like '%$search%' or source like '%$search%' or category like '%$search%' or payment_method like '%$search%' or received_from like '%$search%' or description like '%$search%' or cheqe_num like '%$search%' and del=1 ORDER BY income_id DESC";
    }
