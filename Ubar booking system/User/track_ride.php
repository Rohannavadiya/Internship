    ...
    <div class="container">
        ...
        <div class="navbar">
            ...
            <div class="nav-links">
                ...
                <a href="track_ride.php" class="active">Track Ride</a>
            ...
            <?php if ($ride) { ?>
                ...
                <div class="grid">
                    <div class="info">
                        ...
                        <p><?= htmlspecialchars($ride['pickup_location']); ?></p>
                    </div>

                    <div class="info">
                        <h4>Drop Location</h4>
                        <p><?= htmlspecialchars($ride['drop_location']); ?></p>
                    </div>

                    <div class="info">
                        <h4>Distance</h4>
                        <p><?= htmlspecialchars($ride['distance_km']); ?> km</p>
                    </div>

                    <div class="info">
                        <h4>Fare</h4>
                        <p>₹<?= htmlspecialchars($ride['fare']); ?></p>
                    </div>
                </div>
