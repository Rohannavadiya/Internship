...
/* Sidebar */
.sidebar{
    width:260px;background:#fff;box-shadow:0 10px 30px rgba(0,0,0,0.08);
    padding:25px 20px;position:sticky;top:0;height:100vh;
}
.brand{font-size:22px;font-weight:700;color:#facc15;margin-bottom:25px;}
.profile-box{
    background:#f9fafb;border-radius:16px;padding:18px;margin-bottom:25px;border:1px solid #f1f5f9;
}
...
.menu a{
    ...
    color:#374151;font-weight:500;margin-bottom:10px;transition:0.25s;
}
.menu a:hover{background:#facc15;color:#000;}
.menu a.active{background:#facc15;color:#000;}
...
/* Card */
.card{
    max-width:900px;background:#fff;padding:22px;border-radius:18px;
    box-shadow:0 10px 30px rgba(0,0,0,0.06);border:1px solid #f1f5f9;
}
...
.user-info h3{font-size:18px;margin-bottom:3px;}
...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="topbar">
            <h2>Driver <span>Profile</span></h2>
        ...
        <div class="card">
            ...
            <div class="avatar-box">
                <div class="avatar">
                    ...
                    <img src="../assets/images/<?= (!empty($profile_image)) ? $profile_image : "default_user.png"; ?>" alt="Profile">
                </div>

                <div class="user-info">
                    <h3><?= htmlspecialchars($full_name); ?></h3>
                    <p>CabRide Driver • <?= htmlspecialchars($vehicle_type); ?></p>
                </div>
            </div>
            ...
            <div class="info-grid">
                ...
                <div class="info-box">
                    <small>Mobile</small>
                    <span><?= htmlspecialchars($mobile); ?></span>
                </div>

                <div class="info-box">
                    <small>License Number</small>
                    <span><?= htmlspecialchars($license_number); ?></span>
                </div>
                ...
                <div class="info-box">
                    ...
                    <span style="color:#1d4ed8;"><?= htmlspecialchars($availability); ?></span>
                </div>

                <div class="info-box">
                    <small>Account Status</small>
                    <span style="color:#047857;"><?= htmlspecialchars($status); ?></span>
                </div>
